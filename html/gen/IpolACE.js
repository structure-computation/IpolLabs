...
IpolACEItem = (function(_super) {

  __extends(IpolACEItem, _super);

  function IpolACEItem(name) {
    var constant, gaussian, interp, poly, radial;
    if (name == null) name = "IpolACE";
...
TreeAppApplication_IpolACE = (function(_super) {

  __extends(TreeAppApplication_IpolACE, _super);
  ...
  function TreeAppApplication_IpolACE() {
    ...
    this.actions.push({
      ...
      fun: function(evt, app) {
        ...
        return ipolLsd = _this.add_item_depending_selected_tree(app.data, IpolACEItem);
      }
    });
  }
...
RadialWeight = (function(_super) {

  __extends(RadialWeight, _super);
...
InterpolateMethod = (function(_super) {

  __extends(InterpolateMethod, _super);
...
GaussianWeight = (function(_super) {

  __extends(GaussianWeight, _super);
...
PolynomialMethod = (function(_super) {

  __extends(PolynomialMethod, _super);
...
ConstantWeight = (function(_super) {

  __extends(ConstantWeight, _super);
