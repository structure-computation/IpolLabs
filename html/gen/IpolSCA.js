...
TreeAppApplication_IpolSCA = (function() {
  __extends(TreeAppApplication_IpolSCA, TreeAppApplication);
  function TreeAppApplication_IpolSCA() {
    ...
    this.tutorial_link = 'http://youtu.be/ayS5oDTgF7E';
    ...
    this.actions.push({
      ...
      fun: __bind(function(evt, app) {
        ...
        return ipolSCA = this.add_item_depending_selected_tree(app.data, IpolSCAItem);
      }, this)
    });
  }
