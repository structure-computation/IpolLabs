...
TreeAppApplication_IpolLSD = (function() {
  __extends(TreeAppApplication_IpolLSD, TreeAppApplication);
  function TreeAppApplication_IpolLSD() {
    ...
    this.tutorial_link = 'http://youtu.be/TXmLqJS0nvE';
    ...
    this.actions.push({
      ...
      fun: __bind(function(evt, app) {
        ...
        return ipolLsd = this.add_item_depending_selected_tree(app.data, IpolLSDItem);
      }, this)
    });
  }
