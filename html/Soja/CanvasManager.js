...
CanvasManager = (function(_super) {
  ...
  function CanvasManager(params) {
    ...
    dv = function(field, fun) {
      if (!(_this[field] != null)) return _this[field] = fun();
    };
    dv("items", function() {
      return new Lst;
    });
  ...
  CanvasManager.prototype.onchange = function() {
    if (this.need_to_redraw()) return this.draw();
  };
  ...
  CanvasManager.prototype.bounding_box = function() {
    ...
    if (this._bounding_box != null) return this._bounding_box;
    ...
    if (x_min[0] === +1e40) return [[-1, -1, -1], [1, 1, 1]];
  ...
  CanvasManager.prototype.draw = function() {
    ...
    this._flat.sort(function(a, b) {
      if (!(a.z_index != null) || !(b.z_index != null)) console.log(a, b);
  ...
  CanvasManager.prototype.selected_items_rec = function(l) {
    var item, res, sub_item, _i, _j, _len, _len2, _ref;
    if (l == null) l = this.selected_items();
    res = [];
    for (_i = 0, _len = l.length; _i < _len; _i++) {
      item = l[_i];
      res.push(item);
  ...
  CanvasManager.prototype.gl_vert = function(src) {
    var _this = this;
    return this._get_buf_obj("vert", src, function() {
  ...
  CanvasManager.prototype.gl_frag = function(src) {
    var _this = this;
    return this._get_buf_obj("frag", src, function() {
  ...
  CanvasManager.prototype.gl_prog = function(vert_src, frag_src) {
    ...
    return this._get_buf_obj("prog", src, function() {
  ...
  CanvasManager.prototype._make_gl_program = function(vert, frag) {
    ...
    if (this.ctx.getProgramParameter(prog, this.ctx.LINK_STATUS)) return prog;
...
ServerAssistedVisualization = (function() {
  ...
  function ServerAssistedVisualization(app, bs) {
    ...
    bind([bs, ds._layout], __bind(function() {
      ...
      _ref3 = (function() {
        var _j, _len, _ref3, _results2;
        _ref3 = this.layout._attribute_names;
        _results2 = [];
...
Cam = (function(_super) {
  ...
  function Cam(want_aspect_ratio) {
    if (want_aspect_ratio == null) want_aspect_ratio = false;
  ...
  Cam.prototype.pan = function(x, y, w, h, ctrl_key) {
    var c, d, r, _results;
    if (ctrl_key == null) ctrl_key = false;
    if (ctrl_key) {
      x /= 10;
      y /= 10;
    }
  ...
  Cam.prototype.zoom = function(x, y, c, w, h) {
    ...
    if (typeof c === "number") {
      ...
      if (this.r != null) this.r.set(this.r.get() * c[1] / c[0]);
...
PointMesher = (function(_super) {
  ...
  PointMesher.prototype.on_mouse_move = function(cm, evt, pos, b, old) {
    ...
    if (b === "LEFT" && (this._movable_entity != null)) {
      if ((_ref = cm.undo_manager) != null) _ref.snapshot();
...
Mesh = (function(_super) {
  ...
  Mesh.prototype.nb_elements = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      el = _ref[_i];
      if (typeof el.indices.size(1) === "number") res += el.indices.size(1);
    }
    return res;
  };
  ...
  Mesh.prototype.draw = function(info) {
    ...
    if ((_ref8 = this.points) != null ? _ref8.length : void 0) {
      proj = (function() {
        var _len9, _ref9, _results;
        _ref9 = this.points;
        _results = [];
        for (i = 0, _len9 = _ref9.length; i < _len9; i++) {
          p = _ref9[i];
          _results.push(info.re_2_sc.proj(p.pos.get()));
        }
        return _results;
  ...
  Mesh.prototype.on_mouse_down = function(cm, evt, pos, b, old, points_allowed) {
    ...
    if (points_allowed == null) points_allowed = true;
  ...
  Mesh.prototype.on_mouse_move = function(cm, evt, pos, b, old) {
    ...
    if ((_ref = this.visualization.point_edition) != null ? _ref.get() : void 0) {
      if ((this._moving_point != null) && b === "LEFT") {
        if ((_ref2 = cm.undo_manager) != null) _ref2.snapshot();
        p_0 = cm.cam_info.sc_2_rw.pos(pos[0], pos[1]);
        d_0 = cm.cam_info.sc_2_rw.dir(pos[0], pos[1]);
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        ...
        for (d = 0; d < 3; d++) {
          ...
          _results2.push(x_max[d] = Math.max(x_max[d], p[d]));
        }
        return _results2;
      })());
    }
    ...
    if (index_selected_points.length) {
      ...
      for (_i = 0, _len = index_selected_points.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
            el = _ref[_j];
            _results2.push(el.make_curve_line_from_selected(sel_point));
          }
          return _results2;
        }).call(this));
      }
    ...
    if (index_selected_points.length) {
      ...
      for (_i = 0, _len = index_selected_points.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
            el = _ref[_j];
            _results2.push(el.break_line_from_selected(sel_point));
          }
          return _results2;
        }).call(this));
      }
  ...
  Mesh.prototype.delete_selected_point = function() {
    ...
    if (index_selected_points.length > 0) {
      _results = [];
      for (ind = _ref = index_selected_points.length - 1; _ref <= 0 ? ind <= 0 : ind >= 0; _ref <= 0 ? ind++ : ind--) {
        sel_point = index_selected_points[ind];
        p = this.points[sel_point];
        n_array = (function() {
          var _ref2, _results2;
          _results2 = [];
          for (i = 0, _ref2 = this.points.length; 0 <= _ref2 ? i < _ref2 : i > _ref2; 0 <= _ref2 ? i++ : i--) {
            _results2.push(i);
          }
          return _results2;
        }).call(this);
        n_array[sel_point] = -1;
        for (j = _ref2 = sel_point + 1, _ref3 = this.points.length; _ref2 <= _ref3 ? j < _ref3 : j > _ref3; _ref2 <= _ref3 ? j++ : j--) {
          n_array[j] -= 1;
        }
        _ref4 = this._elements;
        ...
        _results.push((function() {
          var _k, _len3, _ref6, _results2;
          _ref6 = this._elements;
          _results2 = [];
          for (_k = 0, _len3 = _ref6.length; _k < _len3; _k++) {
            el = _ref6[_k];
            _results2.push(typeof el.update_indices === "function" ? el.update_indices(done, n_array) : void 0);
          }
          return _results2;
        }).call(this));
      }
  ...
  Mesh.prototype._get_indices_of_selected_points = function() {
    ...
    for (j = 0, _len = _ref.length; j < _len; j++) {
      ...
      for (_i = 0, _len2 = _ref2.length; _i < _len2; _i++) {
        sel_point = _ref2[_i];
        if (point === sel_point) index_selected_points.push(j);
      }
    }
...
Axes = (function(_super) {
  ...
  Axes.prototype._coords = function(info) {
    ...
    d = this.d.get();
    if (d < 0 || !this.p.equals("mm")) d = info.cam.d.get() / 10;
...
Legend = (function(_super) {
  ...
  function Legend(title, show_legend, auto_fit) {
    if (title == null) title = "Big title";
    if (show_legend == null) show_legend = true;
    if (auto_fit == null) auto_fit = true;
...
Transform = (function() {
  ...
  Transform.prototype.draw = function(info) {
    ...
    if (this.cur_points.length && draw_point) {
      ...
      _results = [];
      for (n = 0, _ref3 = proj.length; 0 <= _ref3 ? n < _ref3 : n > _ref3; 0 <= _ref3 ? n++ : n--) {
        info.ctx.lineWidth = 1;
        info.ctx.strokeStyle = "#333311";
        info.ctx.fillStyle = "#333311";
        p = proj[n];
...
Img = (function(_super) {
  ...
  function Img(src, app, need_fit) {
    ...
    if (need_fit == null) need_fit = true;
    ...
    onload = function() {
      ...
      if (_this._histo.length === 0) _this.fill_histogram();
  ...
  Img.prototype.draw = function(info) {
    ...
    if (!(this.data.rgba != null)) return false;
    this.X = [1, 0, 0];
    this.Y = [0, 1, 0];
    this.Z = [0, 0, -1];
    this.O = [0, 0, 0];
  ...
  Img._draw_persp_rec = function(info, rgba, zmin, zmax, O, X, Y, Z, _date_tex, tex, src, xmin, ymin, xmax, ymax, rec) {
    ...
    if (info.ctx_type === "gl") {
      ...
      if (!(_date_tex[gl.ctx_id] != null)) _date_tex[gl.ctx_id] = -1;
      if (_date_tex[gl.ctx_id] < src._date_last_modification) {
        _date_tex[gl.ctx_id] = src._date_last_modification;
        if (tex[gl.ctx_id] != null) gl.deleteTexture(tex[gl.ctx_id]);
      ...
      if (a[0] < 0 && b[0] < 0 && c[0] < 0 && d[0] < 0) return true;
...
Graph = (function() {
  ...
  Graph.prototype.draw_legend = function(info) {
    ...
    value = [];
    posit = [];
    for (i = 0, _ref = this.legend_x_division.get(); 0 <= _ref ? i <= _ref : i >= _ref; 0 <= _ref ? i++ : i--) {
    ...
    for (i = 0, _ref3 = this.legend_x_division.get(); 0 <= _ref3 ? i <= _ref3 : i >= _ref3; 0 <= _ref3 ? i++ : i--) {
    ...
    value = [];
    posit = [];
    for (i = 0, _ref4 = this.legend_y_division.get(); 0 <= _ref4 ? i <= _ref4 : i >= _ref4; 0 <= _ref4 ? i++ : i--) {
    ...
    for (i = 0, _ref6 = this.legend_y_division.get(); 0 <= _ref6 ? i <= _ref6 : i >= _ref6; 0 <= _ref6 ? i++ : i--) {
      nice_val = this.get_significative_number(value[i], [min, max]);
  ...
  Graph.prototype.draw_grid = function(info) {
    ...
    for (i = 1, _ref = this.legend_x_division.get(); 1 <= _ref ? i < _ref : i > _ref; 1 <= _ref ? i++ : i--) {
      pos = orig[0] + ((width_axis - orig[0]) / this.legend_x_division.get()) * i;
      info.ctx.moveTo(pos, orig[1]);
      info.ctx.lineTo(pos, height_axis);
      info.ctx.stroke();
    }
    for (i = 1, _ref2 = this.legend_y_division.get(); 1 <= _ref2 ? i < _ref2 : i > _ref2; 1 <= _ref2 ? i++ : i--) {
...
ElementaryField = (function(_super) {
  ...
  ElementaryField.prototype.draw = function(info, parameters, additionnal_parameters) {
    ...
    if (parameters != null) {
      ...
      if (info.ctx_type === "gl") {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          el = _ref[_i];
          if (!(el.indices._data != null)) continue;
        ...
        proj = (function() {
          var _len2, _len3, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _results, _results2;
          if (((additionnal_parameters != null ? additionnal_parameters.warp_by : void 0) != null) && this._mesh.points.length === ((_ref2 = additionnal_parameters.warp_by._vector[0]) != null ? (_ref3 = _ref2._data[0]) != null ? (_ref4 = _ref3.field) != null ? (_ref5 = _ref4._data.size()) != null ? _ref5[0] : void 0 : void 0 : void 0 : void 0)) {
  ...
  ElementaryField.prototype._update_gl_bufs = function(info, nn, el, offset_el) {
    ...
    gl = info.ctx;
    ni = nn + "_" + gl.ctx_id;
    if (!(this._date_bufs[ni] != null)) this._date_bufs[ni] = -1;
    if (this._date_bufs[ni] < this._data._date_last_modification || this._date_bufs[ni] < this._mesh._date_last_modification) {
      ...
      if (this._data_buffer[ni] != null) gl.deleteBuffer(this._data_buffer[ni]);
      ...
      for (i = 0, _ref = el.indices.size(1); 0 <= _ref ? i < _ref : i > _ref; 0 <= _ref ? i++ : i--) {
        for (j = 0, _ref2 = el.indices.size(0); 0 <= _ref2 ? j < _ref2 : j > _ref2; 0 <= _ref2 ? j++ : j--) {
  ...
  ElementaryField.prototype._get_max = function(l) {
    var i, max, val, _ref;
    if (l.length > 0) max = l[0];
    for (i = 1, _ref = l.length; 1 <= _ref ? i < _ref : i > _ref; 1 <= _ref ? i++ : i--) {
      val = l[i];
      if (val > max) max = val;
    }
    return max;
...
InterpolatedField = (function(_super) {
  ...
  InterpolatedField.prototype.get_sub_field = function(info) {
    ...
    for (n = 0, _len = _ref.length; n < _len; n++) {
      ...
      if (t.pos[0].axe_name.equals("time")) {
        if (t.pos[0].axe_value.get() >= info.time) return t.field;
      }
    }
    if (this._data.length) return this._data[this._data.length - 1].field;
  };

  InterpolatedField.prototype.get_val = function(info, i) {
    var f;
    f = this.get_sub_field(info);
    if (f != null) return f.get_val(info, i);
  };
  ...
  InterpolatedField.prototype.draw = function(info, parameters, additionnal_parameters) {
    ...
    f = this.get_sub_field(info);
    if (f != null) return f.draw(info, parameters, additionnal_parameters);
  };
...
NodalField = (function(_super) {
  ...
  NodalField.prototype._update_gl_bufs = function(info, nn, el) {
    ...
    if (this._date_bufs[ni] < this._data._date_last_modification || this._date_bufs[ni] < this._mesh._date_last_modification) {
      ...
      ne = el.indices._data.length;
      val = new Float32Array(ne);
      for (i = 0; 0 <= ne ? i < ne : i > ne; 0 <= ne ? i++ : i--) {
...
VectorialField = (function(_super) {
  ...
  VectorialField.prototype.dim = function() {
    if (this._vector) return this._vector.length;
    return 0;
  };
  ...
  VectorialField.prototype.rem_child = function(child) {
    ...
    if (ind > 0) return this._vector.splice(ind, 1);
  };
  ...
  VectorialField.prototype.draw_vectorial_field = function(info, display_style, points, values, legend, warp_factor, norm) {
    ...
    if (warp_factor == null) warp_factor = 1;
    if (norm == null) norm = true;
    if (display_style === "Arrow") {
      ...
      for (ind = 0, _len = points.length; ind < _len; ind++) {
        ...
        if (element.length === 2) element.push(0);
  ...
  VectorialField.prototype.warp_gl_buff = function(info, el, buff_id) {
    ...
    gl = info.ctx;
    if (!(this._date_pts[buff_id] != null)) this._date_pts[buff_id] = -1;
    if (this._date_pts[buff_id] < this._vector._date_last_modification) {
      ...
      for (i = 0, _ref = el.indices.size(1); 0 <= _ref ? i < _ref : i > _ref; 0 <= _ref ? i++ : i--) {
        for (nn = 0, _ref2 = el.indices.size(0); 0 <= _ref2 ? nn < _ref2 : nn > _ref2; 0 <= _ref2 ? nn++ : nn--) {
...
ImageField = (function(_super) {
  ...
  function ImageField(name, path) {
    ...
    this.src.bind(function() {
      if (_this.src.length) return _this.rgba.src = _this.src.get();
    });
    this._date_tex = {};
    this.tex = {};
  }
...
Element_BoundedSurf = (function(_super) {
  ...
  Element_BoundedSurf.prototype.draw = function(info, mesh, proj, is_a_sub) {
    ...
    if ((_ref = mesh.visualization.display_style.get()) === "Surface" || _ref === "Surface with Edges") {
      ...
      info.theme.surfaces.draw(info, function() {
        var b, n, _len, _ref2, _results;
        _ref2 = _this.boundaries;
        _results = [];
        for (n = 0, _len = _ref2.length; n < _len; n++) {
          b = _ref2[n];
    ...
    for (n = 0, _len = _ref.length; n < _len; n++) {
      ...
      if (divisions[b.e.model_id] != null) {
        if (b.o < 0) {
          ...
          if (d.length) {
            for (nl = _ref2 = d.length - 1; _ref2 <= 0 ? nl <= 0 : nl >= 0; _ref2 <= 0 ? nl++ : nl--) {
              res.push({
                o: b.o,
                e: d[nl]
              });
  ...
  Element_BoundedSurf.prototype.add_sub_element = function(res) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      b = _ref[_i];
      if (_ref2 = b.e, __indexOf.call(res, _ref2) < 0) {
...
Element_TriangleList = (function(_super) {
  ...
  Element_TriangleList.prototype.draw = function(info, mesh, proj, is_a_sub) {
    ...
    if ((_ref = mesh.visualization.display_style.get()) === "Surface" || _ref === "Surface with Edges") {
      lt = (function() {
        var _ref2, _results;
        _results = [];
        for (i = 0, _ref2 = this.indices.size(1); 0 <= _ref2 ? i < _ref2 : i > _ref2; 0 <= _ref2 ? i++ : i--) {
    ...
    if ((_ref2 = mesh.visualization.display_style.get()) === "Wireframe" || _ref2 === "Surface with Edges") {
      ...
      for (i = 0, _ref3 = this.indices.size(1); 0 <= _ref3 ? i < _ref3 : i > _ref3; 0 <= _ref3 ? i++ : i--) {
        p = (function() {
          var _results;
          _results = [];
          for (j = 0; j < 3; j++) {
  ...
  Element_TriangleList.prototype.draw_nodal_field = function(info, proj, data, display_style, legend) {
    ...
    indices = (function() {
      var _ref, _results;
      _results = [];
      for (num_triangle = 0, _ref = this.indices.size(1); 0 <= _ref ? num_triangle < _ref : num_triangle > _ref; 0 <= _ref ? num_triangle++ : num_triangle--) {
  ...
  Element_TriangleList.prototype._update_bufs = function(info, mesh, points) {
    ...
    gl = info.ctx;
    if (!(this._date_pts[gl.ctx_id] != null)) this._date_pts[gl.ctx_id] = -1;
    if (this._date_pts[gl.ctx_id] < mesh._date_last_modification) {
      ...
      for (i = 0, _ref = this.indices.size(1); 0 <= _ref ? i < _ref : i > _ref; 0 <= _ref ? i++ : i--) {
  ...
  Element_TriangleList.prototype._draw_gradient_fill_triangle = function(info, p0, p1, posit, legend) {
    var col, lineargradient, _i, _len, _ref;
    info.ctx.beginPath();
    if (isNaN(p0[0]) || isNaN(p0[1]) || isNaN(p1[0]) || isNaN(p1[1])) return;
  ...
  Element_TriangleList.prototype.draw_elementary_triangle = function(info, proj, data, display_style, legend) {
    ...
    for (num_triangle = 0, _ref = this.indices.size(1); 0 <= _ref ? num_triangle < _ref : num_triangle > _ref; 0 <= _ref ? num_triangle++ : num_triangle--) {
      ...
      if (info.ctx_type === "2d") {
        ...
        if (!(this._sf != null)) this._sf = new SurfaceTheme;
        p0 = (function() {
...
Element_Arc = (function(_super) {
  ...
  Element_Arc.prototype.draw_gl = function(info, mesh, points, is_a_sub, theme) {
    if (theme == null) theme = info.theme.lines;
  ...
  Element_Arc.prototype.contour = function(info, mesh, proj, beg, inversion) {
    ...
    points = (function() {
      ...
      if (inversion) {
        _results = [];
        for (p = _ref = this.indices.length - 1; _ref <= 0 ? p <= 0 : p >= 0; _ref <= 0 ? p++ : p--) {
  ...
  Element_Arc.prototype.closest_point_closer_than = function(best, mesh, proj, info, pos) {
    ...
    if (this.indices.length) {
      _results = [];
      for (i = 0, _ref = this.indices.length - 1; 0 <= _ref ? i < _ref : i > _ref; 0 <= _ref ? i++ : i--) {
...
Element_Line = (function(_super) {
  ...
  Element_Line.prototype.draw = function(info, mesh, proj, is_a_sub, theme) {
    ...
    if (wf || !is_a_sub) {
      theme.beg_ctx(info);
      if (this.indices.length) {
        for (i = 0, _ref2 = this.indices.length - 1; 0 <= _ref2 ? i < _ref2 : i > _ref2; 0 <= _ref2 ? i++ : i--) {
  ...
  Element_Line.prototype.contour = function(info, mesh, proj, beg, inversion) {
    ...
    if (this.indices.length >= 2) {
      if (inversion) {
        _results = [];
        for (i = _ref = this.indices.length - 2; _ref <= 0 ? i <= 0 : i >= 0; _ref <= 0 ? i++ : i--) {
