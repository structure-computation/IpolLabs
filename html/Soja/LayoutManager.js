...
LayoutManagerData = (function() {
  __extends(LayoutManagerData, Model);
  ...
  LayoutManagerData.prototype.find_parent_of_panel_id = function(id, data) {
    ...
    if (data.children != null) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        c = _ref[_i];
        if ((_ref2 = c.panel_id) != null ? _ref2.equals(id) : void 0) {
          return data;
        }
  ...
  LayoutManagerData.prototype._make_graph_rec = function(lst, data, border_size, orig) {
    ...
    if ((_ref = data.children) != null ? _ref.length : void 0) {
      for (num_ci = 0, _ref2 = data.children.length; (0 <= _ref2 ? num_ci < _ref2 : num_ci > _ref2); (0 <= _ref2 ? num_ci += 1 : num_ci -= 1)) {
      ...
      if (repr.children.length) {
        for (n = 0, _ref3 = repr.children.length - 1; (0 <= _ref3 ? n < _ref3 : n > _ref3); (0 <= _ref3 ? n += 1 : n -= 1)) {
  ...
  LayoutManagerData.prototype._make_sizes = function(repr, p_min, p_max) {
    ...
    if (repr.children.length) {
      ...
      for (num_ci = 0, _ref = repr.children.length - 1; (0 <= _ref ? num_ci < _ref : num_ci > _ref); (0 <= _ref ? num_ci += 1 : num_ci -= 1)) {
      ...
      while (true) {
        ...
        for (n = 0, _ref3 = repr.children.length; (0 <= _ref3 ? n < _ref3 : n > _ref3); (0 <= _ref3 ? n += 1 : n -= 1)) {
          if (con[n]) {
            continue;
          }
      ...
      _results = [];
      for (num_ci = 0, _ref4 = repr.children.length; (0 <= _ref4 ? num_ci < _ref4 : num_ci > _ref4); (0 <= _ref4 ? num_ci += 1 : num_ci -= 1)) {
...
LayoutManager = (function() {
        ...
        _results.push(__bind(function(i) {
          return new_dom_element({
            ...
            onmousedown: __bind(function(evt) {
              return this._cut_border_mouse_down(i % 2, i >= 2, evt);
            }, this),
            style: {
              position: "absolute",
  ...
  LayoutManager.prototype.render = function() {
    ...
    this._int_edges = (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        p = _ref[_i];
        if (p.d_border != null) {
          _results.push(__bind(function(p) {
            return new_dom_element({
              parentNode: this.el,
              className: "LayoutManager_Border",
              onmousedown: __bind(function(evt) {
                return this._int_border_mouse_down(p, evt);
              }, this),
              style: {
                position: "absolute",
  ...
  LayoutManager.prototype.hide = function() {
    ...
    for (_j = 0, _len2 = _ref3.length; _j < _len2; _j++) {
      b = _ref3[_j];
      _results.push(b.parentNode === this.el ? this.el.removeChild(b) : void 0);
    }
    return _results;
  };
  ...
  LayoutManager.prototype._int_border_mouse_down = function(repr, evt) {
    ...
    this.el.onmouseup = __bind(function(evt) {
      return this._int_border_mouse_up(repr, evt);
    }, this);
    this.el.onmouseout = __bind(function(evt) {
      return this._int_border_mouse_out(repr, evt);
    }, this);
    this.el.onmousemove = __bind(function(evt) {
      return this._int_border_mouse_move(repr, evt);
    }, this);
  ...
  LayoutManager.prototype._cut_border_mouse_down = function(d, s, evt) {
    ...
    this.el.onmouseup = __bind(function(evt) {
      return this._cut_border_mouse_up(d, s, evt);
    }, this);
    this.el.onmouseout = __bind(function(evt) {
      return this._cut_border_mouse_out(d, s, evt);
    }, this);
    this.el.onmousemove = __bind(function(evt) {
      return this._cut_border_mouse_move(d, s, evt);
    }, this);
    if (typeof evt.preventDefault === "function") {
      evt.preventDefault();
    }
  ...
  LayoutManager.prototype._cut_border_mouse_up = function(d, s, evt) {
    var di, info, p, _i, _len, _ref, _results;
    this._end_mouse_interact();
