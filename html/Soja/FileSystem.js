...
ModelEditorItem_Directory = (function(_super) {
  var sort_dir, sort_numerically;

  __extends(ModelEditorItem_Directory, _super);
    ...
    key_map = {
      ...
      13: function(evt) {
        ...
        if (_this.selected_file.length > 0) {
          _ref = _this.selected_file.get();
          _results = [];
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ind_sel_file = _ref[_i];
            index = _this.search_ord_index_from_id(ind_sel_file);
            _results.push(_this.open(_this.model[index], _this.path()));
          }
          return _results;
        }
      },
      ...
      65: function(evt) {
        ...
        if (evt.ctrlKey) {
          ...
          for (i = 0, _len = _ref.length; i < _len; i++) {
            child = _ref[i];
            _results.push(_this.selected_file.push(i));
          }
          return _results;
        }
      },
      88: function(evt) {
        if (evt.ctrlKey) return _this.cut();
      },
      67: function(evt) {
        if (evt.ctrlKey) return _this.copy();
      },
      86: function(evt) {
        if (evt.ctrlKey) return _this.paste();
      },
      46: function(evt) {
        return _this.delete_file();
      },
  ...
  ModelEditorItem_Directory.prototype.paste = function() {
    ...
    if (this.cutroot != null) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (pos !== -1) this.cutroot.splice(pos, 1);
      }
    }
  ...
  ModelEditorItem_Directory.prototype.rename_file = function(file, child_index) {
    ...
    file.focus();
    return file.onblur = function(evt) {
      var title;
  ...
  ModelEditorItem_Directory.prototype.onchange = function() {
    if (this.selected_file.has_been_directly_modified()) this.draw_selected_file();
  ...
  ModelEditorItem_Directory.prototype.load_folder = function(file) {
    ...
    return file._ptr.load(function(m, err) {
      _this.model = m;
  ...
  ModelEditorItem_Directory.prototype.open = function(file, path) {
    ...
    if (file._info.model_type != null) {
      ...
      if ((l != null) && l.length) return l[0](file, path, this);
    }
  };
  ...
  ModelEditorItem_Directory.prototype.load_model_from_breadcrumb = function(ind) {
    ...
    if (ind !== -1) {
      ...
      if (ind === 0) {
        ...
        return this.breadcrumb[ind]._ptr.load(function(m, err) {
  ...
  ModelEditorItem_Directory.prototype.delete_breadcrumb_from_index = function(index) {
    var i, _ref, _results;
    _results = [];
    for (i = _ref = this.breadcrumb.length - 1; _ref <= index ? i < index : i > index; _ref <= index ? i++ : i--) {
  ...
  ModelEditorItem_Directory.prototype.delete_file = function() {
    ...
    if (this.selected_file.length) {
      ...
      for (i = _ref2 = index_array.length - 1; _ref2 <= 0 ? i <= 0 : i >= 0; _ref2 <= 0 ? i++ : i--) {
  ...
  ModelEditorItem_Directory.prototype.draw_selected_file = function() {
    ...
    for (j = 0, _len = file_contain.length; j < _len; j++) {
      ...
      if (parseInt(this.selected_file.indexOf(j)) !== -1) {
        _results.push(add_class(file, 'selected_file'));
      } else {
        _results.push(rem_class(file, 'selected_file'));
      }
    }
    return _results;
  };
  ...
  ModelEditorItem_Directory.prototype.init = function() {
    ...
    _fn = function(elem, i) {
      ...
      file_container = new_dom_element({
        ...
        ondragstart: function(evt) {
          ...
          console.log(_this.drag_source.get(), _this.selected_file);
        ...
        ondrop: function(evt) {
          var ind, index, sorted_ind, _i, _j, _len4, _len5, _ref, _ref2;
          if (sorted[i]._info.model_type.get() === "Directory") {
            _ref = _this.drag_source.get();
            for (_i = 0, _len4 = _ref.length; _i < _len4; _i++) {
              ind = _ref[_i];
              if (sorted[ind] === sorted[i]) return false;
              sorted[i]._ptr.load(function(m, err) {
                return m.push(sorted[ind]);
              });
            }
            _ref2 = _this.drag_source.get();
        ...
        onmousedown: function(evt) {
          ...
          if (evt.ctrlKey) {
            ...
            if (_this.selected_file.length === 0) {
              ...
              _this.selected_file.clear();
              _results = [];
              for (j = index_last_file_selected; index_last_file_selected <= i ? j <= i : j >= i; index_last_file_selected <= i ? j++ : j--) {
                _results.push(_this.selected_file.push(j));
              }
              return _results;
            }
          } else {
    ...
    if (this.use_breadcrumb) this.draw_breadcrumb();
...
ModelEditorItem.default_types.unshift(function(model) {
  if (model instanceof Directory) return ModelEditorItem_Directory;
});
var Directory;
