...
Vec_3 = (function(_super) {
  ...
  Vec_3.determinant = function(a) {
    ...
    if (n === 1) {
      ...
      d = 0;
      for (j1 = 0; 0 <= n ? j1 < n : j1 > n; 0 <= n ? j1++ : j1--) {
        m = (function() {
          var _results;
          _results = [];
  ...
  Vec_3.solve = function(M, B) {
    ...
    if (M[0].length != null) {
      ...
      if (M[0].length !== n) console.log("pb with solve args");
      m = (function() {
        var _results;
        _results = [];
