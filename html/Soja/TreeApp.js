...
TreeItem = (function(_super) {
  ...
  TreeItem.prototype.rem_child = function(child) {
    ...
    if (child instanceof TreeItem) {
      for (num_c = 0, _ref = this._children.length; 0 <= _ref ? num_c < _ref : num_c > _ref; 0 <= _ref ? num_c++ : num_c--) {
  ...
  TreeItem.prototype.rem_output = function(child) {
    var num_c, _ref;
    if (child instanceof TreeItem) {
      for (num_c = 0, _ref = this._output.length; 0 <= _ref ? num_c < _ref : num_c > _ref; 0 <= _ref ? num_c++ : num_c--) {
        ...
        if (current.accept_child(it)) {
          ...
          for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
            ...
            _results2.push((function() {
              ...
              _ref2 = app.data.visible_tree_items[p];
              _results3 = [];
    ...
    this.stop_compute_action = {
      ...
      fun: function(evt, app) {
        ...
        for (_i = 0, _len = items.length; _i < _len; _i++) {
          path_item = items[_i];
          item = path_item[path_item.length - 1];
          if (item._computation_state.get() === true || item._pending_state.get() === true || item._processing_state.get() === true || item._finish_state.get() === true) {
            _results.push(item.stop_it());
          } else {
            _results.push(void 0);
          }
        }
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len2 = suppl_act.length; _j < _len2; _j++) {
          ...
          if (act instanceof TreeAppModule) {
            (function(act) {
              var in_act, _k, _len3, _ref2, _results;
              _ref2 = act.actions;
              _results = [];
              for (_k = 0, _len3 = _ref2.length; _k < _len3; _k++) {
                in_act = _ref2[_k];
                _results.push((function(in_act) {
            ...
            if (!(context_actions.contains(act))) context_actions.push(act);
          }
        }
        if (item._context_actions != null) {
          ...
          for (_k = 0, _len3 = _ref2.length; _k < _len3; _k++) {
            ...
            if (act instanceof TreeAppModule) {
              (function(act) {
                var in_act, _l, _len4, _ref3, _results;
                _ref3 = act.actions;
                _results = [];
  ...
  ContextBar.prototype.create_list_menu = function(act, parent, key, size) {
    ...
    if ((act.ico != null) && act.ico.length > 0) {
      new_dom_element({
        ...
        onmousedown: function(evt) {
          var _ref;
          return (_ref = act.sub.act[0]) != null ? _ref.fun(evt, _this.tree_app) : void 0;
        }
      });
    }
...
TreeApp = (function(_super) {

  __extends(TreeApp, _super);
  ...
  TreeApp.prototype.all_canvas_inst = function() {
    ...
    for (ch in _ref) {
      key = _ref[ch];
      if (key instanceof CanvasManagerPanelInstance) cmpi.push(key);
    }
    return cmpi;
  };
  ...
  TreeApp.prototype._new_LayoutManager = function(session) {
    ...
    res.new_panel_instance = function(data) {
  ...
  TreeApp.prototype._new_panel_instance = function(display_settings, data) {
    ...
    if (data.panel_id === "TreeView") {
      ...
      res.div.onmousedown = function() {
        _this.data.focus.set(_this.module_treeview.treeview.view_id);
        return true;
      };
      return res;
    }
    ...
    bind(this.data.selected_canvas_pan, function() {
    ...
    if (!(this.data.visible_tree_items[data.panel_id] != null)) {
      ...
      for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
        id = _ref2[_j];
        if (!(this.data.visible_tree_items[id].length >= 2)) continue;
  ...
  TreeApp.prototype._on_key_down = function(evt) {
    ...
    if (this.active_key.get()) {
      if ((16 <= (_ref = evt.keyCode) && _ref <= 18)) return;
      cur_key = "";
      if (evt.ctrlKey) cur_key += "Ctrl+";
      if (evt.shiftKey) cur_key += "Shift+";
      if (evt.altKey) cur_key += "Alt+";
      special_keys = {
        8: "BackSpace",
        9: "Tab",
        13: "Enter",
    ...
    for (_i = 0, _len = actions.length; _i < _len; _i++) {
      ...
      if ((a.key != null) && (!(a.ina != null) || !a.ina(this))) {
        ...
        for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
          k = _ref[_j];
          if (k === cur_key) {
            if (typeof a.fun === "function") a.fun(evt, this);
...
IcoBar = (function(_super) {

  __extends(IcoBar, _super);
  ...
  IcoBar.prototype.onchange = function() {
    ...
    if (this.app_data.selected_tree_items.has_been_directly_modified) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (item._context_modules != null) {
          ...
          for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
            module = _ref2[_j];
            if (!(context_modules.contains(module))) context_modules.push(module);
          }
        }
      }
    }
    this._render_loc_actions(this.tree_app);
    if (this.loc === true) return;
    ...
    for (_k = 0, _len3 = context_modules.length; _k < _len3; _k++) {
      ...
      if ((m.visible != null) && m.visible === false) continue;
      _results.push((function(m) {
        var act, big_icon, block, icon_bot, icon_top, j, module_title, parent, _fn, _len4, _ref3, _results2;
        block = new_dom_element({
          parentNode: _this.div,
          nodeName: "span",
          className: "module"
        });
        if (m.right != null) block.style.float = "right";
        ...
        _results2 = [];
        for (j = 0, _len4 = _ref3.length; j < _len4; j++) {
          act = _ref3[j];
          if (!(act.vis !== false && act.loc !== true)) continue;
          _fn(act);
          _results2.push(module_title = new_dom_element({
            parentNode: block,
            nodeName: "div",
  ...
  IcoBar.prototype._render_loc_actions = function(tree_app) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      m = _ref[_i];
      _results.push((function(m) {
        var act, j, _len2, _ref2, _results2;
        _ref2 = m.actions;
        _results2 = [];
        for (j = 0, _len2 = _ref2.length; j < _len2; j++) {
          act = _ref2[j];
          if (act.loc === true) {
            _results2.push((function(act) {
              var de;
              de = new_dom_element({
                nodeName: "img",
                src: act.ico,
      ...
      for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
        ...
        if (!(o != null)) {
          ...
          if (((_ref4 = s.img) != null ? _ref4.information : void 0) != null) {
            ...
            s.bind(function() {
              var _ref5;
              return (_ref5 = s.img) != null ? _ref5.information(d) : void 0;
            });
          }
...
CanvasManagerPanelInstance = (function(_super) {

  __extends(CanvasManagerPanelInstance, _super);
  ...
  function CanvasManagerPanelInstance(el, app_data, view_item, undo_manager) {
    ...
    this.cm = new CanvasManager({
      ...
      context_menu: function(evt, show) {
        return _this._launch_context_menu(evt, show);
      },
      add_transform: function(evt, show) {
    ...
    this.cm.active_items = function() {
      var i, res, _ref;
      res = [];
      if (((_ref = _this.cm) != null ? _ref.items : void 0) != null) {
        res = (function() {
    ...
    this.cm.selected_items = function() {
      var s, _i, _len, _ref, _results;
      _ref = _this.app_data.selected_tree_items;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        s = _ref[_i];
    ...
    this.cm.select_canvas_fun.push(function(cm, evt) {
      _this.app_data.focus.set(_this.cm.view_id);
      if (evt.ctrlKey) {
    ...
    this.cm.click_fun.push(function(cm, evt) {});
    this.cm.dblclick_fun.push(function(cm, evt) {
      return _this._add_transform_node(evt);
    });
    bind(this.app_data.selected_canvas_pan, function() {
  ...
  CanvasManagerPanelInstance.prototype.destructor = function() {
    ...
    if (typeof (_base = this.cm).destructor === "function") _base.destructor();
    delete this.cm;
      ...
      if (c.ico != null) {
        _results.push((function(c) {
          ...
          elem = new_dom_element({
            ...
            onclick: function(evt) {
              c.fun(evt, _this.app_data._views[0]);
        ...
        if (c.ico != null) {
          (function(c) {
            ...
            elem = new_dom_element({
              ...
              onclick: function(evt) {
                var fun, _j, _len2, _ref;
                _ref = _this.cm.select_canvas_fun;
                for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
                  fun = _ref[_j];
                  fun(_this.cm, evt);
                }
                return c.fun(evt, _this.app_data._views[0]);
              }
            });
            new_dom_element({
              parentNode: elem,
...
TreeAppData = (function(_super) {
  ...
  TreeAppData.prototype.selected_session = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      session = _ref[_i];
      if (this.has_a_selected_child(session)) return session;
    }
  ...
  TreeAppData.prototype.update_associated_layout_data = function(d) {
    ...
    _ref = (function() {
      ...
      for (_j = 0, _len = _ref.length; _j < _len; _j++) {
        key = _ref[_j];
        if (__indexOf.call(pil, key) < 0) _results.push(key);
      }
      return _results;
    }).call(this);
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    _ref2 = (function() {
      ...
      _ref2 = this.selected_canvas_pan;
      _results = [];
  ...
  TreeAppData.prototype.get_current_cam = function() {
    ...
    for (i = 0, _ref = this.selected_display_settings()._children.length; 0 <= _ref ? i < _ref : i > _ref; 0 <= _ref ? i++ : i--) {
  ...
  TreeAppData.prototype.has_a_selected_child = function(item) {
    var c, _i, _len, _ref;
    if (__indexOf.call(this.selected_tree_items, item) >= 0) return true;
    _ref = item._children;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      c = _ref[_i];
      if (this.has_a_selected_child(c)) return true;
    }
    return false;
  };
  ...
  TreeAppData.prototype.get_root_path_in_selected = function(item) {
    var it, path, _i, _j, _len, _len2, _ref;
    _ref = this.selected_tree_items;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      path = _ref[_i];
      for (_j = 0, _len2 = path.length; _j < _len2; _j++) {
        it = path[_j];
        if (it.model_id === item.model_id) return path;
      }
    }
  };
  ...
  TreeAppData.prototype.delete_from_tree = function(item, root) {
    ...
    if (item._children.length) {
      for (i = _ref = item._children.length - 1; _ref <= 0 ? i <= 0 : i >= 0; _ref <= 0 ? i++ : i--) {
        c = item._children[i];
        if (c._children.length > 0) this.delete_from_tree(c, false);
        child = true;
        item.rem_child(c);
  ...
  TreeAppData.prototype._get_parent = function(item) {
    ...
    if (parent === item) {
      ...
      while (parent === item && i < 50) {
        if (path[i].length > 1) parent = path[i][path[i].length - 2];
        i++;
      }
    }
    return parent;
  ...
  TreeAppData.prototype._get_child_of_type_rec = function(res, visited, item, type) {
    ...
    if (!(visited[item.model_id] != null)) {
      ...
      if (item instanceof type) res.push(item);
  ...
  function TreeItem_Computable() {
    ...
    this.bind(function() {
      if (_this.real_change()) {
        if (_this._computation_req_date.has_been_modified()) return;
        if (_this._computation_rep_date.has_been_modified()) return;
...
ImgSetItem = (function(_super) {
  ...
  ImgSetItem.prototype.z_index = function() {
    if (this._children.length) return this._children[0].z_index();
    return 0;
  };
...
ViewItem = (function(_super) {
  ...
  ViewItem.prototype.draw = function(info) {
    ...
    if (info.ctx_type === '2d') {
      ...
      if (this._buff.width) {
        vs = "                    attribute vec3 a_position;                    attribute vec2 textureCoords;                    varying vec2 texcoords;                    void main( void ) {                        texcoords = textureCoords;                        gl_Position = vec4( a_position, 1.0 );                    }                ";
...
CollectionTreeItem = (function(_super) {
  ...
  CollectionTreeItem.prototype.change_collection = function() {
    ...
    if (this._children.length > this._collection_size) {
      ...
      _results = [];
      for (num_c = size_child0_child, _ref = this._collection_size; size_child0_child <= _ref ? num_c < _ref : num_c > _ref; size_child0_child <= _ref ? num_c++ : num_c--) {
...
TreeAppModule_TreeView = (function(_super) {
  ...
  function TreeAppModule_TreeView() {
        ...
        for (_i = 0, _len = path_items.length; _i < _len; _i++) {
          ...
          if ((_ref = item._viewable) != null ? _ref.get() : void 0) {
            _results.push((function() {
              ...
              for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
                p = _ref2[_j];
                _results2.push(app.data.visible_tree_items[p].toggle(item));
              }
              return _results2;
            })());
          } else {
    ...
    this.actions.push({
      ...
      ina: _ina,
      fun: function(evt, app) {
        var m, mod, modules, path, _i, _j, _len, _len2, _ref;
  ...
  TreeAppModule_TreeView.prototype.is_close = function(app, item) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (item.equals(closed_item_path)) return true;
    }
    return false;
  };
      ...
      fun: function(evt, app) {
        ...
        for (_i = 0, _len = items.length; _i < _len; _i++) {
          ...
          if ((typeof FileSystem !== "undefined" && FileSystem !== null) && (FileSystem.get_inst() != null)) {
            ...
            dir_save = "/home/projet_" + SC_MODEL_ID;
    ...
    save_sub.sub.act.push({
      ...
      fun: function(evt, app) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (path.length > 1) {
            m = path[path.length - 1];
            if (m instanceof DisplaySettingsItem || m instanceof ViewItem) {} else {
