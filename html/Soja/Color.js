...
Gradient = (function() {
  ...
  Gradient.prototype.get_fragment_shader = function(v, m, n) {
    ...
    for (col = 1, _ref = dc.length; (1 <= _ref ? col < _ref : col > _ref); (1 <= _ref ? col += 1 : col -= 1)) {
      if (m.length) {
...
ModelEditorItem_ColorPicker = (function() {
  ...
  ModelEditorItem_ColorPicker.prototype._init_sat = function(base) {
    ...
    _results = [];
    for (x = 0, _ref = this.sat_lum.width; (0 <= _ref ? x < _ref : x > _ref); (0 <= _ref ? x += 1 : x -= 1)) {
      h = x / (this.sat_lum.width - 1.0);
...
ModelEditorItem_GradientPicker = (function() {
  ...
  ModelEditorItem_GradientPicker.prototype.build_color_picker = function() {
    ...
    for (i = 0, _ref = this.model.color_stop.length; (0 <= _ref ? i < _ref : i > _ref); (0 <= _ref ? i += 1 : i -= 1)) {
    ...
    return _drag_end_func = __bind(function(evt) {
      ...
      if (del_picker === true) {
        ...
        if (index !== this.model.color_stop.length) {
          for (i = _ref = index + 1, _ref2 = this.model.color_stop.length; (_ref <= _ref2 ? i <= _ref2 : i >= _ref2); (_ref <= _ref2 ? i += 1 : i -= 1)) {
            this.remove_color_picker(i);
          }
          _results = [];
          for (i = index, _ref3 = this.model.color_stop.length; (index <= _ref3 ? i <= _ref3 : i >= _ref3); (index <= _ref3 ? i += 1 : i -= 1)) {
