...
LineTheme = (function() {
  ...
  LineTheme.prototype.contour_arc = function(info, P0, P1, P2, beg) {
    ...
    pt = [];
    ls = [];
    for (ai = _ref = 1 - beg; (_ref <= n ? ai <= n : ai >= n); (_ref <= n ? ai += 1 : ai -= 1)) {
  ...
  LineTheme.prototype.contour_interpolated_arcs = function(info, points, beg) {
    ...
    res = (function() {
      var _ref, _results;
      _results = [];
      for (i = 0, _ref = points.length - 2; (0 <= _ref ? i < _ref : i > _ref); (0 <= _ref ? i += 1 : i -= 1)) {
    ...
    for (i = 0, _ref = points.length - 3; (0 <= _ref ? i < _ref : i > _ref); (0 <= _ref ? i += 1 : i -= 1)) {
      for (n = 0; n < 30; n++) {
        alpha = n / 30.0;
...
SurfaceTheme = (function() {
  __extends(SurfaceTheme, Model);
